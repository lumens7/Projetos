...
import br.com.luis.Vendas.domain.Venda.Status;
import br.com.luis.Vendas.dto.VendaDTO;
import br.com.luis.Vendas.repository.IVendasRepository;
import br.com.luis.Vendas.service.ClienteService;
import br.com.luis.Vendas.service.IProdutoService;
import br.com.luis.Vendas.exception.*;
...
public class CadastroVenda {
	...
	@Autowired
	public CadastroVenda(IVendasRepository produtoRepository,
	...
	public Venda adicionarProduto(String id, String idProduto, Integer quantidade) {
		Venda venda = buscarVenda(id);
	...
	public Venda removerProduto(String id, String idProduto, Integer quantidade) {
		Venda venda = buscarVenda(id);
		Produto produto = buscarProduto(idProduto);
		venda.validarStatus();
